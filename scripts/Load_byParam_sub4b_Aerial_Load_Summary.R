...
cat(paste("Row:  ", i, "      Parameter=", ParameterList[i], sep=""))
cat("\n")
...
Case.list.area <- rbind(Case.list.area, data.frame(ParameterList[i], case.code, pctCensor, nSamples, num.Detects, 
...
#write.csv(Case.list, paste(outputDirectory, "Param_Summary_Aerial_Loads.csv", sep="/"))
#write.csv(Case.list, paste(outputDirectory, "Param_Summary_Aerial_Loads_Landuse.csv", sep="/"))
#write.csv(Case.list, paste(outputDirectory, "Param_Summary_Aerial_Loads_Season.csv", sep="/"))
